...
int ut2=graph.edges[ut0+1].ipe;
 ...
 if( ((struct struct_hgraph  *)(graph.extra))->dist[ut1]>newdist+((struct struct_hgraph  *)(graph.extra))->dist[id] )//END
{

 ((struct struct_hgraph  *)(graph.extra))->dist[ut1]=newdist+((struct struct_hgraph  *)(graph.extra))->dist[id]; 
