...
void   drefine ( struct node  unni ,HGraph & graph ,Pusher0 &current, Pusher1 &collnext, int   nblocks ,int   size ,int   goal ,unsigned volatile int *   arrayin ,unsigned volatile int *   arrayout ) 
 {
...
conn4= create_coll_device(100);
 ...
 t1=((struct struct_hgraph  *)(current.extra))->id[unni]; 
