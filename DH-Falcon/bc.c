...
if( ((struct struct_hgraph  *)(graph.extra))->dist/*xx*/[ut1]>(val+1) ){

 ((struct struct_hgraph  *)(graph.extra))->dist/*xx*/[ut1]=val+1; 
...
cudaSetDevice(0);
 ...
 (null)  temp2;
 cudaMemcpy((void *)&temp2,coll1,sizeof( (null)),cudaMemcpyDeviceToHost);
int falcvt3;
...
cudaDeviceSynchronize();
 ...
 int   falcvt5;
falcvt5=0;
if(cudaMemcpyToSymbol(changed,&(falcvt5),sizeof(int ),0,cudaMemcpyHostToDevice)!=cudaSuccess)printf("memcpyerror 2");//val=1 
...
coll2.ptr=coll3.ptr;
 ...
 (null)  temp3;
 cudaMemcpy((void *)&temp3,coll2,sizeof( (null)),cudaMemcpyDeviceToHost);
//val=2 
//Dtype -1 4=
cudaMemcpy(&temp,coll2.size/**/,sizeof(int),cudaMemcpyDeviceToHost);
 ...
 (null)  temp4;
 cudaMemcpy((void *)&temp4,coll1,sizeof( (null)),cudaMemcpyDeviceToHost);
cudaMemcpy(coll1.size/**/,&temp,sizeof(int),cudaMemcpyHostToDevice);
 ...
 (null)  temp5;
 cudaMemcpy((void *)&temp5,coll2,sizeof( (null)),cudaMemcpyDeviceToHost);
