...
struct globvar_in_fun{
dir_decl *d1;
struct globvar_in_fun *next;
};
...
bool stcomp,cpugpu,hetero;//cpugpu for partitioned execution
int gpugpu;//for partitioned execution
